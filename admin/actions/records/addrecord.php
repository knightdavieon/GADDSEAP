		...
		if ($uploadOk == 0) {
			...
			if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_dir . $newfilename)) {
				...
				$insertpersonal->execute(array(
					...
					"ex" => ucwords($suffix),
					"addressbrgy" => ucwords($addbrgy),
					"addressmun" => ucwords($addmun),
					"addressprov" => ucwords($addprov),
				...
				$insertfamily->execute(array(
					...
					"siblings_1" => ucwords($siblings_1),
					"1_age" => $age1,
					"1_occupation" => ucwords($occupation1),
					"siblings_2" => ucwords($siblings_2),
					"2_age" => $age2,
					"2_occupation" => ucwords($occupation2),
					"siblings_3" => ucwords($siblings_3),
					"3_age" => $age3,
					"3_occupation" => ucwords($occupation3),
					"spouse" => ucwords($spouse),
					"spouse_age" => $spouse_age,
					"spouse_occupation" => ucwords($spouse_occupation)
				));
